                    ...
                    <form action="{{ route('admin.aparatur.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <x-input id="nama" class="block mt-1 w-full p-2" type="text" name="nama" :value="old('nama')" required autofocus placeholder="Masukkan nama lengkap" />
                            </div>

                            <!-- Jabatan -->
                            <div>
                                <x-label for="jabatan" value="{{ __('Jabatan') }}" />
                                <x-input id="jabatan" class="block mt-1 w-full p-2" type="text" name="jabatan" :value="old('jabatan')" required placeholder="Contoh: Kepala Desa" />
                            </div>

                            <!-- Foto -->
                            <div>
                                <x-label for="foto" value="{{ __('Foto (Maks 2MB)') }}" />
                                <input id="foto" class="p-2 block mt-1 w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" type="file" name="foto" required accept="image/*">
