                    ...
                    <form action="{{ route('admin.berita.update', $berita->id) }}" method="POST"
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <div class="mt-2">
                                    <img id="foto-lama" src="{{ asset('storage/' . $berita->foto) }}" alt="Foto saat ini"
                                        class="h-40 rounded-md object-cover mb-2">
                                    <img id="preview-foto" class="h-40 rounded-md object-cover" style="display: none;">
                                </div>
                                <input id="foto"
                                    class="block mt-2 w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 p-2"
                                    type="file" name="foto">
