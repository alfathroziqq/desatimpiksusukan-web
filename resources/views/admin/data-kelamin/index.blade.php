                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div>
                                    ...
                                    <x-input id="laki_laki" class="block mt-1 w-full p-2" type="number" name="laki_laki"
                                        :value="old('laki_laki', $data->laki_laki ?? 0)" required min="0" />
                                </div>
                                <div>
                                    <x-label for="perempuan" value="{{ __('Jumlah Perempuan (jiwa)') }}" />
                                    <x-input id="perempuan" class="block mt-1 w-full p-2" type="number" name="perempuan"
                                        :value="old('perempuan', $data->perempuan ?? 0)" required min="0" />
                                </div>
                                <div>
                                    <x-label for="kepala_keluarga" value="{{ __('Jumlah Kepala Keluarga') }}" />
                                    <x-input id="kepala_keluarga" class="block mt-1 w-full p-2" type="number"
