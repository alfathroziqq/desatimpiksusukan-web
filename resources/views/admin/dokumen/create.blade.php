                    ...
                    <form action="{{ route('admin.dokumen.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <x-input id="judul" class="block mt-1 w-full p-2" type="text" name="judul"
                            ...
                            <div>
                                ...
                                <x-input id="tanggal_input" class="block mt-1 w-full p-2" type="date" name="tanggal_input"
                                    :value="old('tanggal_input')" required placeholder="Masukkan Tanggal Input" />
                            </div>

                            <!-- Upload Dokumen PDF -->
                            <div>
                                <x-label for="file_path" value="{{ __('Upload Dokumen (PDF, maks 5MB)') }}" />
                                <input id="file_path" class="p-2 block mt-1 w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" type="file" name="file_path" required>
                            </div>
