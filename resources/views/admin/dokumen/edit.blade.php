                    ...
                    <form action="{{ route('admin.dokumen.update', $dokumen->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <x-input id="judul" class="block mt-1 w-full p-2" type="text" name="judul" :value="old('judul', $dokumen->judul)" required autofocus />
                            </div>

                            <!-- Jenis Dokumen -->
                            <div>
                                <x-label for="jenis_dokumen" value="{{ __('Jenis Dokumen') }}" />
                                <select name="jenis_dokumen" id="jenis_dokumen" class="p-2 block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">
                            ...
                            <div>
                                ...
                                <x-input id="tanggal_input" class="block mt-1 w-full p-2" type="date" name="tanggal_input" :value="old('tanggal_input', $dokumen->tanggal_input)" required />
                            </div>

                            <!-- Upload Dokumen PDF -->
                            <div>
                                <x-label for="file_path" value="{{ __('Upload Dokumen Baru (Opsional)') }}" />
                                ...
                                <input id="file_path" class="p-2 block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" type="file" name="file_path">
