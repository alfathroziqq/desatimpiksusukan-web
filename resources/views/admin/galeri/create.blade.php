                    ...
                    <form action="{{ route('admin.galeri.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <x-input id="judul" class="block mt-1 w-full p-2" type="text" name="judul" :value="old('judul')" required autofocus placeholder="Masukkan judul gambar" />
                            </div>

                            <!-- Gambar -->
                            <div>
                                <x-label for="gambar" value="{{ __('File Gambar (Maks 2MB)') }}" />
                                <input id="gambar" class="p-2 block mt-1 w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" type="file" name="gambar" required accept="image/*">
