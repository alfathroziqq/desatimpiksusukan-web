        ...
        <section class="py-12 md:py-10 bg-white" style="font-family: 'Poppins', sans-serif;">
            <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="text-center mb-12 md:mb-16 reveal-on-scroll">
                    <h2 class="text-3xl md:text-4xl font-bold text-[#0C3B2E]">
                        Berita Desa
                    </h2>
                    <div class="w-24 h-1.5 bg-[#0C3B2E] mx-auto mt-2"></div>
                </div>
                            ...
                            <a href="{{ route('berita.detail', $berita->id) }}" class="block">
                                ...
                                <div class="p-5">
                                    ...
                                    <div class="flex justify-between items-center text-xs text-gray-500">
                                        <span>{{ \Carbon\Carbon::parse($berita->tanggal)->format('j F Y') }}</span>
