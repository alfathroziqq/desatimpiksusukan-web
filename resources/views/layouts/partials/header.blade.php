        ...
        <div class="hidden lg:flex items-center space-x-13 text-sm text-[13px] uppercase tracking-wider">
            ...
            <div class="relative" x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false">
                ...
                <div x-show="open" x-transition class="absolute mt-2 w-48 bg-[#254D43] rounded-md shadow-xl z-20"
                    ...
                    <a href="{{ route('data-pendidikan') }}" class="block px-4 py-2 text-sm text-gray-200 hover:bg-white/10">Data Pendidikan</a>
                    ...
                    <a href="{{ route('data-ekonomi') }}" class="block px-4 py-2 text-sm text-gray-200 hover:bg-white/10">Data Ekonomi</a>
                </div>
            </div>
        ...
        <div class="flex flex-col px-4 pt-2 pb-4 space-y-1">
            ...
            <div>
                ...
                <div x-show="activeAccordion === 'data'" class="pl-4 mt-1 space-y-1">
                    ...
                    <a href="{{ route('data-pendidikan') }}" class="block py-2 px-3 text-sm text-gray-300 hover:text-white hover:bg-white/5 rounded-md">Data Pendidikan</a>
                    ...
                    <a href="{{ route('data-ekonomi') }}" class="block py-2 px-3 text-sm text-gray-300 hover:text-white hover:bg-white/5 rounded-md">Data Ekonomi</a>
                </div>
            </div>
