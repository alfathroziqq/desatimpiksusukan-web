...
<head>
    ...
    <meta name="description" content="Mapping Desa Timpik, Kecamatan Susukan, Kabupaten Semarang.">

    <link rel="canonical" href="https://desatimpiksusukan.id/mapping-desa" />

    <meta name="keywords"
        content="Desa Timpik, Susukan, Kabupaten Semarang, mapping desa, mapping">
            ...
            <div class="mt-[-30px] container mx-auto px-8 sm:px-12 lg:px-40">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-10 text-center">
                    ...
                    <div class="reveal-on-scroll text-center">
                        <h3 class="font-semibold text-lg md:text-2xl mb-3 text-[#0C3B2E]">Peta Administrasi Desa</h3>
                    ...
                    <!-- Item 2 -->
                    <div class="reveal-on-scroll text-center">
                        <h3 class="font-semibold text-lg md:text-2xl mb-3 text-[#0C3B2E]">Peta Jenis Lahan Pertanian</h3>
                    ...
                    <!-- Item 3 -->
                    <div class="reveal-on-scroll text-center">
                        <h3 class="font-semibold text-lg md:text-2xl mb-3 text-[#0C3B2E]">Peta Aliran Sungai & Bak Air</h3>
                    ...
                    <!-- Item 4 -->
                    <div class="reveal-on-scroll text-center">
                        <h3 class="font-semibold text-lg md:text-2xl mb-3 text-[#0C3B2E]">Peta Rumah Kepala Desa</h3>
                    ...
                    <!-- Item 5 -->
                    <div class="reveal-on-scroll text-center">
                        <h3 class="font-semibold text-lg md:text-2xl mb-3 text-[#0C3B2E]">Peta Fasilitas Pendidikan</h3>
                    ...
                    <!-- Item 6 -->
                    <div class="reveal-on-scroll text-center">
                        <h3 class="font-semibold text-lg md:text-2xl mb-3 text-[#0C3B2E]">Peta Fasilitas Kesehatan</h3>
                    ...
                    <!-- Item 7 -->
                    <div class="reveal-on-scroll text-center">
                        <h3 class="font-semibold text-lg md:text-2xl mb-3 text-[#0C3B2E]">Peta Persebaran Hewan Ternak</h3>
                    ...
                    <!-- Item 8 -->
                    <div class="reveal-on-scroll text-center">
                        <h3 class="font-semibold text-lg md:text-2xl mb-3 text-[#0C3B2E]">Peta Sosial Budaya</h3>
                    ...
                    <!-- Item 9 -->
                    <div class="reveal-on-scroll text-center">
                        <h3 class="font-semibold text-lg md:text-2xl mb-3 text-[#0C3B2E]">Peta Aliran Listrik & Titik Lampu</h3>
